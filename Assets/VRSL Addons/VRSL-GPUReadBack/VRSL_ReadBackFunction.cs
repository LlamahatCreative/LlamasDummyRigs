...
namespace VRSL{
    ...
    /////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        [SerializeField]
        private string[] dataPointNames = new string[512];
    ...
    public class VRSL_ReadBackFunction_Editor : Editor
    {
        ...
        SerializedProperty dataStringActive, dataBoolActive, dataIntActive, dataFloatActive, eventSpamToggle, eventSpamDelay, eventFireReset, eventFireResetThreshold, animationTriggerReset, animationTriggerResetThreshold, animationTriggerParamsThreshold, dataPointNames;
        ...
        void OnEnable()
        {
            ...
            dataPointNames = serializedObject.FindProperty("dataPointNames");
...

    {
        ...
        public void DrawElement(int index, VRSL_ReadBackFunction targetScript)
        {
            ...
            dataPointNames.GetArrayElementAtIndex(index).stringValue = EditorGUILayout.TextField("Name", dataPointNames.GetArrayElementAtIndex(index).stringValue);
        ...
        public override void OnInspectorGUI()
        {
           ...
           // EditorGUILayout.PropertyField(extendedUniverseMode, Label("Extended Universe Mode"));
            ...
            for(int i = 0; i < Mathf.Min(Mathf.Max(size.intValue, 1), 512); i++)
            {
                dataFoldout.GetArrayElementAtIndex(i).boolValue = EditorGUILayout.BeginFoldoutHeaderGroup(dataFoldout.GetArrayElementAtIndex(i).boolValue,
                dataPointNames.GetArrayElementAtIndex(i).stringValue == string.Empty ? "Data Point #" + i : dataPointNames.GetArrayElementAtIndex(i).stringValue, 
                Title1Foldout());
